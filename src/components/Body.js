...
const Body = () => {
  const [resList, setResList] = useState([
    ...
    },
    {
      info: {
        ...
        name: "Subway",
        cloudinaryImageId:
          "RX_THUMBNAIL/IMAGES/VENDOR/2024/6/4/d2c2136d-2a69-4f0d-82b7-67427d105af1_47395.JPG",
        locality: "Bopal",
  ...
  const fetchData = async () => {
    const data = await fetch(
      "https://www.swiggy.com/dapi/restaurants/list/v5?lat=27.59400&lng=75.13670&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING"
    );
    const json = await data.json();
    console.log(json);
    setResList(json.data.cards.card[1].gridElements.infoWithStyle.restaurants)
  };
